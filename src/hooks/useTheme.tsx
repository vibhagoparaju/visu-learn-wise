...
export const THEMES: ThemeMeta[] = [
  {
    ...
    swatches: ["#f5f1e8", "#7a8559", "#3d4a2a"],
    isDark: false,
  },
  {
    id: "dark-premium",
    name: "Dark Premium",
    tagline: "Black & gold — refined depth",
    swatches: ["#0e0d0b", "#c9a14a", "#e8c468"],
    isDark: true,
  },
  {
    id: "royal",
    name: "Royal",
    tagline: "Burgundy — warm authority",
    swatches: ["#1a0d10", "#7a1f2b", "#c9778a"],
    isDark: true,
  },
  {
    id: "midnight",
